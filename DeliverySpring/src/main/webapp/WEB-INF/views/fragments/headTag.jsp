...
<link href="<c:url value="/resources/css/delivery.css" />" rel="stylesheet" />

<script src="<c:url value="/resources/js/delivery.js" />"></script>
...
<script src="<c:url value="/webjars/bootbox/4.2.0/bootbox.min.js" />"></script>